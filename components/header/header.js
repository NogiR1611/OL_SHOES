                ...
                <header>
                    <div className="flex justify-between items-center bg-gray-100 text-gray-800 p-2">
                        ...
                        <div className="inline-block mr-10">
                            ...
                            <button className="transition duration-300 ease-in-out hover:bg-gray-300 rounded-full h-16 w-16">
                                <Profile className="inline-block stroke-current stroke-0 black" width={24} height={24} strokeWidth="10" />
                            </button>
                        </div>
                    </div>
                </header>
