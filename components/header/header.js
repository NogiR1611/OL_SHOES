        ...
        return (
            <>
                <header className="w-full sticky top-0 z-50"> 
                    <div className="flex justify-between items-center bg-gray-100 text-gray-800 px-2 py-8 md:p-2">
                        <div className="inline-block">
                            ...
                            <Link href="/home">
                                <span className="mx-2 cursor-pointer text-lg md:text-xl align-middle font-medium">OL Shoes</span>
                            </Link>
                        </div> 
                        <div className="inline-block">
                            {this.props.displayDownload ?
                                (
                                    <button
                                        className="transition duration-300 ease-in-out focus:outline-none hover:bg-gray-300 rounded-full mx-2 h-10 w-10 md:h-16 md:w-16"
                            ...
                            {this.props.displayFilter ? 
                                (
                                    <button
                                        className="transition duration-300 ease-in-out focus:outline-none hover:bg-gray-300 rounded-full mx-2 h-6 w-6 md:h-16 md:w-16"
