        ...
        return (
            ...
            >
                <div className="bg-gray-lighter w-full md:w-480 items-center">
                    ...
                    <p className="text-black-darker text-base hp-one:text-xl font-semibold py-4 px-1 hp-one:px-6">Urutkan Produk Berdasarkan</p>
                    <div className="w-full pt-2 mb-4 px-3 hp-one:px-6">
                        <button
                            onClick={() => this.setState({ clickType: 'semua' })}
                            className={
                                "py-2 px-2 text-xs hp-one:text-sm text-right font-medium rounded-lg focus:outline-none mr-3 " +
                                (this.state.clickType === "semua" ? "bg-red-darker-1 hover:opacity-90 active:bg-opacity-50 active:bg-red-darker-1 transition duration-100 ease-in-out text-white" : "bg-gray-300 text-gray-800 transition duration-100 ease-in-out hover:bg-gray-400 text-gray-800")
                            }
                        >
                        ...
                        <button 
                            ...
                            className={
                                "py-2 px-2 text-xs hp-one:text-sm text-right font-medium rounded-lg focus:outline-none " +
                                (this.state.clickType === "tersedia" ? "bg-red-darker-1 hover:opacity-90 active:bg-opacity-50 active:bg-red-darker-1 transition duration-100 ease-in-out text-white" : "bg-gray-300 text-gray-800 transition duration-100 ease-in-out hover:bg-gray-400 text-gray-800")
                            }
                        >
                    ...
                    <div className="px-3 hp-one:px-6 pb-5">
                        <button
                            onClick={() => this.setState({ clickSpec: 'unggulan' })}
                            className="w-full text-left block p-2 text-xs hp-one:text-sm md:text-base text-gray-800 font-medium rounded-lg focus:outline-none  hover:bg-gray-lighter-5 active:bg-gray-lighter-3 transition duration-200 ease-in-out"
                        >
                            Unggulan
