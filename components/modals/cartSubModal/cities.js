    ...
    render(){
        return (
            <Modal
                ...
                open={this.props.onOpenCity}
                onClose={this.props.onCloseCity}
            ...
            >
                <div className="bg-gray-lighter w-full md:w-480 items-center">
                    ...
                    <div className="py-4 px-2 hp-one:px-6">
                        ...
                        <p className="text-xs hp-one:text-sm lg:text-base text-gray-800 py-1">{this.props.provinceName} : </p>
                        ...
                        <div className="w-full max-h-96 text-xs hp-one:text-sm lg:text-base overflow-y-auto">
                            ...
                            .filter(element => {
                                return (
                                    element.name.toLowerCase().includes(this.props.searchCity.toString().toLowerCase())    
                                )
                            })
                            .map( (element,index) => {
                                return (
                                    <div className="w-full pl-6 font-bold text-gray-800" key={index}>
                                        <button
                                            ...
                                            onClick={() => this.props.onClickCity(element.id,element.name)}
                                        >
