                                    ...
                                    <div className="w-full">
                                        <div class="py-2">
                                            <div class="flex items-center mr-4 mb-2 cursor-pointer">
                                                <input type="checkbox" id="A3-yes" name="A3-confirmation" value="yes" className="opacity-0 absolute h-3 w-3 cursor-pointer" />
                                                <div className="cursor-pointer bg-white border-2 rounded-md border-gray-400 w-6 h-6 flex flex-shrink-0 transtion duration-200 ease-linear opacity-1 justify-center items-center mr-2 focus-within:border-red-500">
