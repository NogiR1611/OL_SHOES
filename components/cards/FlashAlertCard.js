...
export default class FlashAlert extends React.Component{
    ...
    render(){
        return (
            <div className={"flex justify-center fixed z-2000 transition duration-500 ease-in-out top-10 left-1/2"}>
                <div className="flex flex-nowrap flex-auto fixed z-1000 top-10 px-4 bg-black h-12 rounded-lg text-center animate-fade text-white">
