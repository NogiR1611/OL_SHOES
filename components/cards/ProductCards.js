...
export default class ProductCards extends React.Component{
    render(){
        return (
            <>
                <Link href="">
                    <div className={(this.props.fullWidth ? "w-full" : "w-1/2 md:w-1/3") + " relative bg-white inline-block flex flex-none self-start flex-col my-2 h-100 border-2 rounded-lg shadow-lg object-contain cursor-pointer transition duration-300 ease-in-out hover:bg-gray-100"}>   
