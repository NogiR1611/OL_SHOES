...
export default class Sidebar extends React.Component{
    render(){
        return (
            <>
                <nav className={"bg-gray-100 top-20 w-2/3 md:w-1/4 xl:w-1/5 min-h-screen fixed z-40 transition duration-500 linear transform lg:translate-x-0 " + (this.props.showSidebar ? "translate-x-0" : "-translate-x-full")}>
                    <div className="py-2">
